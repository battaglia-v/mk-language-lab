        ...
        <div className="px-4 pt-3 pb-3">
          <div className="grid grid-cols-5 gap-3">
            ...
            <Link
              href={buildHref("")}
              className={cn(
                "flex flex-col items-center justify-center gap-1.5 rounded-xl px-3 py-2 transition-colors duration-150 min-h-[3.5rem] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-2 focus-visible:ring-offset-sidebar active:scale-[0.98]",
