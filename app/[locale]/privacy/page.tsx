      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Card className="bg-gradient-to-br from-primary/10 to-secondary/10 backdrop-blur border-primary/20">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground leading-relaxed">{t('gdpr.content')}</p>
              <ul className="space-y-2 ml-4">
          ...
          <Card className="bg-card/50 backdrop-blur border-border/50">
            ...
            <CardContent>
              ...
              <a
                href="mailto:vpbattaglia@gmail.com?subject=Privacy%20Policy%20Inquiry%20-%20Macedonian%20Learning%20App"
