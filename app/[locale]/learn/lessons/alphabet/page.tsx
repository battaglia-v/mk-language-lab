    ...
    <PageContainer size="lg" className="flex flex-col gap-5 pb-24 sm:gap-6 sm:pb-10">
      ...
      <Tabs defaultValue="learn" className="w-full">
        <TabsList className="grid grid-cols-3">
          <TabsTrigger value="learn" data-testid="alphabet-tab-learn">
            <BookOpen className="h-4 w-4" />
            {t('learn', { default: 'Learn' })}
          </TabsTrigger>
          <TabsTrigger value="special" data-testid="alphabet-tab-special">
            <Sparkles className="h-4 w-4" />
            {t('special', { default: 'Special' })}
          </TabsTrigger>
          <TabsTrigger value="practice" data-testid="alphabet-tab-practice">
