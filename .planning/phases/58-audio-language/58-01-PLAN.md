...
status: DEFERRED
deferred_to: v2.0
deferred_date: 2026-01-14
deferred_reason: POC scope - audio/TTS requires Azure integration or native recordings, too complex for initial launch
---

> **⏸️ DEFERRED TO v2.0** - This plan is preserved for future implementation.
> See research notes in this file for Azure TTS and native recording options.
