...
- [ ] `npx expo start --ios` launches app successfully (requires manual testing)
- [ ] No "Invalid hook call" errors in console (requires manual testing)
- [ ] Can navigate between tabs (requires manual testing)
- [ ] Grammar Practice feature works (requires manual testing)
- [ ] Progress saves to AsyncStorage (requires manual testing)
