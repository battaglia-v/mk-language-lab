#!/usr/bin/env tsx
/**
 * Vocabulary Corrections Script - A2 Level
 *
 * Fixes known translation errors in the A2 curriculum vocabulary:
 ...
 * 4. Null translations
 *
 * Based on the A1 corrections script pattern.
 */
...
// ============================================================================
// Corrections Mapping (shared with A1 + A2-specific additions)
// ============================================================================
...
const WORDS_TO_REMOVE = new Set<string>([
  // Add any A2-specific words to remove here
]);

/**
 * Translation corrections for proper names and common errors
 * Includes universal corrections from A1 + A2-specific additions
 */
...
async function main() {
  const inputPath = path.resolve('data/curriculum/structured/a2-lozje.json');
  const backupPath = path.resolve('data/curriculum/structured/a2-lozje.backup.json');
  const outputPath = path.resolve('data/curriculum/structured/a2-lozje.json');

  console.log('📚 Loading A2 curriculum...');
