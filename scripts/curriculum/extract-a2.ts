#!/usr/bin/env npx tsx
/**
 * Extract A2 (Лозје) textbook to raw JSON
 * Produces data/curriculum/extracted/a2-raw.json with position data
 */
...
const PDF_PATH = 'data/curriculum/raw/a2-lozje.pdf';
const OUTPUT_PATH = 'data/curriculum/extracted/a2-raw.json';

async function main() {
  console.log('='.repeat(60));
  console.log('A2 Лозје PDF Extraction');
  console.log('='.repeat(60));
  console.log();
