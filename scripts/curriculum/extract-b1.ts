#!/usr/bin/env npx tsx
/**
 * Extract B1 (Златоврв) textbook to raw JSON
 * Produces data/curriculum/extracted/b1-raw.json with position data
 */
...
const OUTPUT_PATH = 'data/curriculum/extracted/b1-raw.json';

async function main() {
  console.log('='.repeat(60));
  console.log('B1 Златоврв PDF Extraction');
  console.log('='.repeat(60));
  console.log();
